; NOTE: Bug fix by Lin Zhang to read the proper levels.  
;       Also cosmetic changes.  (lzh, bmy, 5/30/08)

pro read_sondes_co_4lev_mozaic_0_5, name, sonde, std_sonde
   ...
   ; Proper levels should be 1,4,9,15 (lzh, bmy, 5/30/08)
   for i=0, 11 do begin
      sonde[i, 0] = means[1, i]
      sonde[i, 1] = means[4, i]
      sonde[i, 2] = means[9, i]
